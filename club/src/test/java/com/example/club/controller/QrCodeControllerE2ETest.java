...
class QrCodeControllerE2ETest extends AbstractE2ETest {
    ...
    void shouldCreateQrCode_WithExternalServiceMock() {
        WIREMOCK.stubFor(WireMock.post(WireMock.urlEqualTo("/api/qr/generate"))
        ...
        assertNotNull(createResponse.getBody(), "Participant creation response body should not be null");
        Long participantId = createResponse.getBody().getId();
        ...
        WIREMOCK.verify(WireMock.postRequestedFor(WireMock.urlEqualTo("/api/qr/generate")));
